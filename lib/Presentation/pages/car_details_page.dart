...
import 'package:car_project/Presentation/pages/maps_details_page.dart';
import 'package:car_project/Presentation/widgets/car_card.dart';
import 'package:car_project/Presentation/widgets/more_card.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          ...
          children: const [Icon(Icons.info_outline), Text('Information')],
        ),
      ),
      body: Column(
        children: [
